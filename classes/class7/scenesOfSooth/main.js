$(document).ready(function() {
  $("#myButton").click(function() {
    var sooths = new Array("assets/sooth0.png", "assets/sooth1.png", "assets/sooth2.png","assets/sooth3.png","assets/sooth4.png","assets/sooth5.png","assets/sooth6.png","assets/sooth7.png","assets/sooth8.png","assets/sooth9.png");
    
    var truths = new Array("The birch canoe slid on the smooth planks.",
    ...
    //pick a truth
    var what = Math.floor(Math.random() * truths.length);
    //pick a position 
    var maxX = window.innerWidth; // this trickiness is to keep sooths away from edges
    var maxY = window.innerHeight;
    var x = Math.floor(Math.random() * maxX*0.7)+50;
    var y = Math.floor(Math.random() * maxY*0.6)+150; 
    
    //pick a sooth 
    var who = Math.floor(Math.random() * sooths.length);
    //place the sooth 
    $("#asooth").attr("src", sooths[who]).css("left", x).css("top",y);
    //have it say something
    $("#truth").html(truths[what]).css("left",x-100).css("top",y-50);
  });
});